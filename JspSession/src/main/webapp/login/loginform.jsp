...
if(saveid==null || saveid.equals("no")){
	myid="";//아이디 저장을 체크하지 않았을때는아이디가 남아있지 않다.
	
	save=false; //체크하지 않았을 경우 false 그 이외에는 초기값이 true 이므로 true가 된다.
}
%>
<div class="loginform">
<h3>회원로그인</h3>
...
class="form-control input-lg" placeholder="로그인할 아이디" required="required"
value="<%=myid %>">
<br>
