		...
		<table class="tablle gtable-bordered" style="width: 600px;">
			...
			<tr>
				<td>
					<h2>
						<b>${dto.subject }</b>
					</h2> <span style="float: right; margin-left: 20px;">
						조회${dto.readcount }&nbsp;&nbsp;&nbsp;&nbsp; <fmt:formatDate
			...
			<tr>
				<td><pre style="background-color: white; border: 0px;">${dto.content }</pre>
					<br>
				<br> <c:if test="${dto.photo!='no' }">
						<c:forTokens var="ps" items="${dto.photo }" delims="">
							<a href="../photo/${ps }"> <img alt="" src="../photo/${ps }"
								style="width: 100px; height: 100px; border: 3px solid green">
							</a>
						</c:forTokens>
