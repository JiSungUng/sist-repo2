...
<button type="button" class= "btn btn-warning" onclick="location.href='board/uploadform1'">이미지업로드</button>
<button type="button" class= "btn btn-warning" onclick="location.href='board/uploadform2'">이미지여러개업로드</button>
