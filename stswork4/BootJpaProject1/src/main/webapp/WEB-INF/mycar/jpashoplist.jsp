...
onclick="location.href='jpaform'">차 정보 추가</button>
	...
	<tr>
	<td>${i.count }</td>
	<td class="detail" num=${dto.num } style="pointer:cursor" onclick="location.href='detail?num=${dto.num}'">${dto.sangpum } <img src="../image/${dto.photo }"></td>
